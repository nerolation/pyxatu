...
class TestDataRetriever(unittest.TestCase):
    ...
    def test_get_attestation_of_slot_exampleSlot(self):
        ...
        func = eval(test)
        exampleSlot = 9000000
        res = func(exampleSlot, columns="epoch, slot, block_slot, meta_network_name, validators, beacon_block_root", orderby="slot, block_slot, beacon_block_root, validators")
        res = shorten_df(res)
    ...
    def test_get_attestation_of_slot_exampleSlotRange(self):
        ...
        func = eval(test)
        exampleSlotRange = [9000000, 9000010]
        res = func(exampleSlotRange, columns="epoch, slot, block_slot, meta_network_name, validators, beacon_block_root", orderby="slot, block_slot, beacon_block_root, validators")
        res = shorten_df(res)
    ...
    def test_get_attestation_of_slot_timeInterval(self):
        ...
        time_interval = "365 days"
        res = func(slot=exampleSlotRange, time_interval=time_interval, columns="epoch, slot, block_slot, meta_network_name, validators, beacon_block_root", orderby="slot, block_slot, beacon_block_root, validators")
        res = shorten_df(res)
